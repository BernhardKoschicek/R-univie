...
# Habsburg Popultion
# Since we only operate at country level, the result isn't quit accurate or something, but well it is the solution to the question but without the needed Dataset. I just say it is a hideous task and since the Autro-Hungarian Empire didn't even EXIST befor the 19th cent. the question is not possible to resolve with the given dataset. 
pop_h_15 = sum(habsburg_frame_15$citypop_le5 * 1000)
pop_h_16 = sum(habsburg_frame_16$citypop_le5 * 1000)
pop_h_17 = NA
pop_h_18 = sum(habsburg_frame_18$citypop_le5 * 1000)

pop_habsburg = c(pop_h_15, pop_h_16, pop_h_17, pop_h_18)
barplot(pop_habsburg, main = "Habsburg Population", xlab = "Century", ylab = "Total")
